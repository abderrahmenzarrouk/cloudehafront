...
export class ReseventsComponent implements OnInit {
  events: any[] = [];
  reservations: any[] = [];
  ...
  getReservationsForEvent(eventId: number): any[] {
    return this.reservations.filter(reservation => reservation.event_id === eventId);
  }
}
